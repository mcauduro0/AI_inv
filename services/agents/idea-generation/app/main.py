"""
Idea Generation Agent - FastAPI Service
"""
import os
import asyncio
...
# Global instances
agent: Optional[IdeaGenerationAgent] = None
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting Idea Generation Agent service...")
    ...
    logger.info("Idea Generation Agent service stopped")
...
app = FastAPI(
    ...
    description="AI-powered investment idea generation service",
    version="1.0.0",
    lifespan=lifespan
)
