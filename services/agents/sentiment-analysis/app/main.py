"""
Sentiment Analysis Agent - FastAPI Service
"""
import os
import asyncio
...
import sys
sys.path.insert(0, '/app/sentiment-analysis')
from app.agent import SentimentAnalysisAgent

logger = structlog.get_logger(__name__)

# Global instances
agent: Optional[SentimentAnalysisAgent] = None
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting Sentiment Analysis Agent service...")
    ...
    logger.info("Sentiment Analysis Agent service stopped")
...
app = FastAPI(
    ...
    description="AI-powered sentiment analysis and social media monitoring service",
    version="1.0.0",
    lifespan=lifespan
)
