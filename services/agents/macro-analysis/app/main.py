"""
Macro Analysis Agent - FastAPI Service
"""
import os
import asyncio
...
import sys
sys.path.insert(0, '/app/macro-analysis')
from app.agent import MacroAnalysisAgent

logger = structlog.get_logger(__name__)

# Global instances
agent: Optional[MacroAnalysisAgent] = None
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting Macro Analysis Agent service...")
    ...
    logger.info("Macro Analysis Agent initialized")
    ...
    logger.info("Macro Analysis Agent service stopped")
...
app = FastAPI(
    title="Macro Analysis Agent",
    description="AI-powered macro analysis and forecasting service",
    version="1.0.0",
    lifespan=lifespan
)
