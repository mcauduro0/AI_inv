"""
Portfolio Management Agent - FastAPI Service
"""
import os
import asyncio
...
import sys
sys.path.insert(0, '/app/portfolio-management')
from app.agent import PortfolioManagementAgent

logger = structlog.get_logger(__name__)

# Global instances
agent: Optional[PortfolioManagementAgent] = None
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting Portfolio Management Agent service...")
    ...
    logger.info("Portfolio Management Agent initialized")
    ...
    logger.info("Portfolio Management Agent service stopped")
...
app = FastAPI(
    ...
    description="AI-powered portfolio management and analysis service",
    version="1.0.0",
    lifespan=lifespan
)
